...
<p align="left">
<img src="https://skillicons.dev/icons?i=nginx,arch,neovim,js,nodejs,htmx,django,fastapi,postgres,linux,vim,bash,git,python,aws,docker,awscli,typescript,react,nextjs,tailwindcss,graphql,mongodb,kubernetes,terraform,redis,express,mysql,rust,go,java" alt="Tech icons" />
</p>
